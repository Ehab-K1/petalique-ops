...
export async function ensureSchema() {
  ...
  // v2.3 — quotation redesign: free-text event date(s) + optional deposit percentage.
  // Line items stay in the flexible `items` JSONB column — older invoices keep their
  // {desc, qty, price} shape and just render without a description line; new invoices
  // use {section, name, detail, qty, price}. No backfill needed.
